...
namespace GAVILANESJOHAO_EXA.Controllers
{
    public class CelularsController : Controller
    {
        ...
        public CelularsController(GAVILANESJOHAO_EXAContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("IdCelular,NombreModelo,año,precio")] Celular celular)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdCelular,NombreModelo,año,precio")] Celular celular)
        {
